(function() {
  ...
  const BUSINESS_PREFIXES = [CLOUD_KEY, SETTINGS_KEY, "vocab_machine_sync_meta_v1", HASH_SYNC_STATE_KEY, HASH_SYNC_STATE_KEY_V1, HASH_BACKUP_PREFIX, DAILY_BACKUP_PREFIX, "vocab_machine_sync_audit_v1", "vocab_machine_corrupt_storage:", PROGRESS_CURSOR_KEY, UNKNOWN_PROGRESS_CURSOR_KEY, PROGRESS_PENDING_KEY, ACTIVITY_DRAFT_KEY, "progress:", "unknown_progress:", "marks:", "mark_states:", "activity:", "unit_stats:", LOCAL_SNAPSHOT_KEY, "shua_ci_ji_sync_lock"];
  let lastBundle = null;
  ...
  function buildRestoreOperations(payload, candidate) {
    ...
    stateRaw.localRecoveryReason = "";
    stateRaw.localRecoverySetAt = "";
    stateRaw.localRecoverySource = "";
    stateRaw.localRecoveryCheckpointHash = "";
